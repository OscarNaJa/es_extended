...
Config.Weapons = {
    ...
    -- { name = "WEAPON_GOLDOFGODDAGGER", label = "GOLDOFGOD", components = {} }, 
    -- { name = "WEAPON_GOLDOFGODDAGGER1", label = "GOLDOFGOD +1", components = {} }, 
    -- { name = "WEAPON_GOLDOFGODDAGGER1", label = "GOLDOFGOD +2", components = {} }, 
    -- { name = "WEAPON_GOLDOFGODDAGGER3", label = "GOLDOFGOD +3", components = {} }, 

    -- { name = "WEAPON_VOIDSWORDBAT", label = "VOIDSWORD", components = {} },
    -- { name = "WEAPON_VOIDSWORDBAT1", label = "VOIDSWORD +1", components = {} },
    -- { name = "WEAPON_VOIDSWORDBAT2", label = "VOIDSWORD +2", components = {} },
    -- { name = "WEAPON_VOIDSWORDBAT3", label = "VOIDSWORD +3", components = {} },
    
    { name = "WEAPON_REVOLVER_LV1", label = "REVOLVER +1", components = {} }, 
    { name = "WEAPON_REVOLVER_LV2", label = "REVOLVER +2", components = {} }, 
    { name = "WEAPON_REVOLVER_LV3", label = "REVOLVER +3", components = {} }, 

    { name = "WEAPON_DARKBOTTLE", label = "DARKBOTTLE", components = {} },
    { name = "WEAPON_DARKPOOL", label = "DARKPOOL", components = {} },

    { name = "WEAPON_BATX", label = "ไม้เบส", components = {} },
    { name = "WEAPON_BATXLV1", label = "ไม้เบส +1", components = {} },
    { name = "WEAPON_BATXLV2", label = "ไม้เบส +2", components = {} },
    { name = "WEAPON_BATXLV3", label = "ไม้เบส +3", components = {} },
    { name = "WEAPON_GOLFCLUBX", label = "ไม้กอล์ฟ", components = {} },
    { name = "WEAPON_GOLFCLUBXLV1", label = "ไม้กอล์ฟ +1", components = {} },
    { name = "WEAPON_GOLFCLUBXLV2", label = "ไม้กอล์ฟ +2", components = {} },
    { name = "WEAPON_GOLFCLUBXLV3", label = "ไม้กอล์ฟ +3", components = {} },
    { name = "WEAPON_POOLCUEX", label = "ไม้พูล", components = {} },
    { name = "WEAPON_POOLCUEXLV1", label = "ไม้พูล +1", components = {} },
    { name = "WEAPON_POOLCUEXLV2", label = "ไม้พูล +2", components = {} },
    { name = "WEAPON_POOLCUEXLV3", label = "ไม้พูล +3", components = {} },
    { name = "WEAPON_BOTTLEX", label = "ปากฉลาม", components = {} },
    { name = "WEAPON_BOTTLEXLV1", label = "ปากฉลาม +1", components = {} },
    { name = "WEAPON_BOTTLEXLV2", label = "ปากฉลาม +2", components = {} },
    { name = "WEAPON_BOTTLEXLV3", label = "ปากฉลาม +3", components = {} },
    { name = "WEAPON_DAGGERX", label = "DAGGER", components = {} },
    { name = "WEAPON_DAGGERXLV1", label = "DAGGER +1", components = {} },
    { name = "WEAPON_DAGGERXLV2", label = "DAGGER +2", components = {} },
    { name = "WEAPON_DAGGERXLV3", label = "DAGGER +3", components = {} },
    { name = "WEAPON_SWITCHBLADEX", label = "SWITCHBLADE", components = {} },
    { name = "WEAPON_SWITCHBLADEXLV1", label = "SWITCHBLADE +1", components = {} },
    { name = "WEAPON_SWITCHBLADEXLV2", label = "SWITCHBLADE +2", components = {} },
    { name = "WEAPON_SWITCHBLADEXLV3", label = "SWITCHBLADE +3", components = {} },
    ...
    -- },
    -- --ADD ON
    -- { name = "WEAPON_KARAMBIT1", label = TranslateCap("weapon_karambit1"), components = {} },
}
